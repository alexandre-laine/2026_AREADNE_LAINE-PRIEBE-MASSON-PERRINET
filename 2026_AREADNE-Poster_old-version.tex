        ...
        \begin{minipage}{0.56\textwidth}
            \begin{tcolorbox}[
                ...
                \begin{minipage}{0.57\textwidth}
                    ...
                    \captionof{figure}{MotionClouds examples from sinusoidal grating (\textbf{C}) to pink noise (\textbf{B}), 2D noise (\textbf{A})and 1D noise (\textbf{D}).}
                \end{minipage}
            \end{tcolorbox}
        \end{minipage}
    \end{minipage}
        ...
        \begin{minipage}{0.645\textwidth}
            \begin{tcolorbox}[ 
                ...
                \begin{minipage}{0.98\textwidth} % Decoding 
                    \includegraphics[width=0.33\textwidth]{part2_g2_theta_B_theta_Accuracy.pdf}
                    \includegraphics[width=0.33\textwidth]{part2_g2_ori_B_theta_Accuracy.pdf}
                    \includegraphics[width=0.33\textwidth]{part2_g2_B_theta_Mean_Accuracy.pdf}
                \end{minipage}

                \begin{minipage}{0.98\textwidth} % Decoding 
                    \includegraphics[width=0.33\textwidth]{part2_g2_theta_B_sf_Accuracy.pdf}
                    \includegraphics[width=0.33\textwidth]{part2_g2_ori_B_sf_Accuracy.pdf}
                    \includegraphics[width=0.33\textwidth]{part2_g2_B_sf_Mean_Accuracy.pdf}
                \end{minipage}
                
                \captionof{figure}{Direction ($\phi$) and orientation ($\theta$) decoding for different orientation and spatial frequency bandwidths ($B_\theta$, $B_{sf}$).}
            \end{tcolorbox}
            \vfill
            \begin{tcolorbox}[
                enhanced,
                ...
                Coupling decoding method and MotionClouds allow us to study how V1 population responses encode orientation and direction information by tiltrating the precision level in orientation and spatial frequency domains.
                In this context, MotionPlaids could offer an interesting next step to study how the brain combines oriented motion components, helping to disentangle orientation and direction contributions to population actiivty and to better understand how motion ambiguity is resolved in V1.
            \end{tcolorbox}
        \end{minipage}    
    \end{minipage}
\end{document}