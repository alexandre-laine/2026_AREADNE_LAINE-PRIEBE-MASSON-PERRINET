        ...
        \begin{minipage}{0.62\textwidth}
            \begin{tcolorbox}[ 
                ...
                \begin{minipage}{0.98\textwidth} % Decoding 
                    \includegraphics[width=0.25\textwidth]{part2_g2_theta_B_theta_Accuracy.pdf}
                    \includegraphics[width=0.25\textwidth]{part2_g2_ori_B_theta_Accuracy.pdf}
                    \includegraphics[width=0.25\textwidth]{part2_g2_1bit_B_theta_Accuracy.pdf}
                    \includegraphics[width=0.25\textwidth]{part2_g2_B_theta_Mean_Accuracy.pdf}
                \end{minipage}

                \begin{minipage}{0.98\textwidth} % Decoding 
                    \includegraphics[width=0.25\textwidth]{part2_g2_theta_B_sf_Accuracy.pdf}
                    \includegraphics[width=0.25\textwidth]{part2_g2_ori_B_sf_Accuracy.pdf}
                    \includegraphics[width=0.25\textwidth]{part2_g2_1bit_B_sf_Accuracy.pdf}
                    \includegraphics[width=0.25\textwidth]{part2_g2_B_sf_Mean_Accuracy.pdf}
                \end{minipage} 
